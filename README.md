# Portfolio Cybersécurité - Rapports d'Audits & Labs

Bienvenue sur mon espace de portfolio technique. Retrouvez ici une sélection mes rapports d'exploitation et rapports d'audits  réalisés dans le cadre de mes entraînements.

## À propos de moi
* **Profil :** Ingénieur de formation en reconversion vers la cybersécurité.
* **Certifications :** CompTIA Security+, eJPT.
* **Plateformes :** HackTheBox, TryHackMe.
...
* **[HTB-Cap - Environnement Linux, Application web, Wireshark, Capabilities]**  
  ...
  * *Rapport d'exploitation (technique) :* [Lien](./mainRapport_exploitation_cap_HTB.pdf)
...
* **[HTB-Orion - Environnement Linux, Analyse des versions, CVEs, Metasploit, Cassage de hash bcrypt]**  
  ...
  * *Rapport d'exploitation (technique) :* [Lien](./mainRapport_exploitation_orion_HTB.pdf)
...
* **[HTB-Checkpoint - Environnement Windows, Active directory, SMB, BloodyAD, Kerberos, Volatility]**  
  ...
  * *Rapport d'exploitation (technique) :* [Lien](./mainRapport_exploitation_Checkpoint_HTB.pdf)
  * *Rapport d'audit (client) :* [Lien](./Rapport_1.pdf)
---
